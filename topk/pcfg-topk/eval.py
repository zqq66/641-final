...
def main(args):
    ...
    with torch.no_grad():
        ...
        for tree in open(args.data_file, "r"):
            ...
            # sents = sents.cuda()
            nll, kl, binary_matrix, topk_spans = model(sents, argmax=True, use_mean=(args.use_mean == 1))
            # argmax_spans
            # print(argmax_spans)
    ...
    # print(all_sents)
    with open('all_sents.pkl', 'wb') as f:
